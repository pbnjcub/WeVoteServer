...
from wevote_functions.functions_date import generate_localized_datetime_from_obj, generate_localized_datetime_from_str
            ...
            if positive_value_exists(google_civic_election_id):
                ...
                if election_result['election_found']:
                    ...
                    if positive_value_exists(election.election_day_text):
                        ...
                        date_of_election = generate_localized_datetime_from_str(election.election_day_text, "%Y-%m-%d")[1]
